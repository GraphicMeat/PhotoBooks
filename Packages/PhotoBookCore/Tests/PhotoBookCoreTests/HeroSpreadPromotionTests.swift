...
@Suite struct HeroSpreadPromotionTests {
    ...
    @Test func noHeroBookIsByteIdenticalToBaseline() throws {
        ...
        // Baseline hash from pre-B4 code (see test doc), re-captured for the
        // schema v5 → v6 stamp (spine text style — the only byte that moved).
        // If you intentionally changed engine or serialization output,
        // re-capture this hash from the new baseline; an UNEXPECTED change here
        // is a determinism regression.
        #expect(hex == "b30e4cc66c2d1a08ab068e3261be93646d65c9280ce576c9becba336cbd99990")
    }
}
